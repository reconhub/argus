...
<!-- uirender(uicard("Reporting completeness (-)", "Week X vs. week y", "Values changed from 17% to 0%")) -->
<!-- uirender(uicard("Avarege yearly completeness 40%", "From to", "Max: 45%, Min: 0%")) -->
...
bscols(widths = c(2,NA),
  list(
    filter_checkbox("no_report_weeks", "Filter table to 8 weeks and longer:", shared_sites_no_report, 
